...
@Mod(modid = Industrial.ID, name = Industrial.NAME, version = Reference.VERSION, dependencies = "required-after:CalclaviaCore;required-after:Artillects|Core;")
@NetworkMod(channels = Reference.CHANNEL, clientSideRequired = true, serverSideRequired = false, packetHandler = PacketHandler.class)
public class Industrial
{
    /** Mod Information */
    public static final String ID = "Artillects|Industrial";
    public static final String NAME = Reference.NAME;

    @Instance(ID)
    public static Industrial INSTANCE;

    @SidedProxy(clientSide = "artillects.industrial.ClientProxy", serverSide = "artillects.industrial.CommonProxy")
