...
{
	TEST("", "[Laggy]Hive complex [A]"), TESTB("", "[Laggy]Hive complex [B]"),
	TUNNELZ("5x5ZTunnel"), TUNNELX("5x5XTunnel"), WALLZ("5x5ZWall"), WALLX("5x5XWall"),
	TUNNELC("5x5CTunnel"), FLOOR("5x5Floor"), SKYLIGHT("5x5SkyLight"), NODE("5x5TunnelNode"),
