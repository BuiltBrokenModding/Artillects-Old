...
public abstract class EntityArtillect extends EntityLivingBase
{
    ...
    private EntitySensesHandler senses;
    ...
    public EntityArtillect(World world)
    {
        ...
        this.senses = new EntitySensesHandler(this);
    }
     ...
     */
    public EntitySensesHandler getEntitySenses()
    {
        return this.senses;
    }
     ...
     * Args:
     *
     * @param p_110162_1_,: The entity to be tethered to.
     * @param p_110162_2_:  Whether to send an attaching notification packet to surrounding players.
     */
