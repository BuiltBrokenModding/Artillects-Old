...
public enum EnumArtillectEntity
{
    ...
    DEMOLISHER("demolisher", new IEntityIndex()
    {
        ...
        public void register()
        {
            EntityRegistry.registerModEntity(EntityMinion.class, "demolisher", ids++, Drone.instance, 100, 1, true);
    ...
    COMBATDRONE("combat", new IEntityIndex()
    {
        ...
        public void register()
        {
            EntityRegistry.registerModEntity(EntityShiv.class, "combatdrone", ids++, Drone.instance, 100, 1, true);
