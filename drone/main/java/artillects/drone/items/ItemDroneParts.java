...
public class ItemDroneParts extends ItemBase
{
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        for (Part part : Part.values())
        {
            part.icon = par1IconRegister.registerIcon(Reference.PREFIX + "dronepart." + part.name);
        }
    }
    ...
    {
        GEARS("gears"),
        CIRCUITS_MELTED_T1("meltedCircuits1"),
        CIRCUITS_MELTED_T2("meltedCircuits2"),
        CIRCUITS_MELTED_T3("meltedCircuits3"),
        CIRCUITS_T1("circuits1"),
        CIRCUITS_T2("circuits2"),
        CIRCUITS_T3("circuits3"),
