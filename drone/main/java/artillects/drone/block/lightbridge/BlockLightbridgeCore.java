package artillects.drone.block.lightbridge;
...
public class BlockLightbridgeCore extends BlockBase implements ITileEntityProvider, IHiveBlock {
    ...
    {
        this.icons[0] = ir.registerIcon(Drone.PREFIX + "lightbridgeCore_top");
        this.icons[1] = ir.registerIcon(Drone.PREFIX + "lightbridgeCore_front");
        this.icons[2] = ir.registerIcon(Drone.PREFIX + "decorWall.0");
    }
