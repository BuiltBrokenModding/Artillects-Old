...
import artillects.drone.client.model.ModelFabricator;
...
{
	public static final ResourceLocation TEXTURE = new ResourceLocation(Drone.DOMAIN, Drone.MODEL_DIRECTORY + "Fabricator.png");
