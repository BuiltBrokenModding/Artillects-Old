package artillects.drone.hive.complex;
...
public class HiveComplex extends HiveEntityObject implements IVirtualObject
{
    ...
    public void loadGeneralBuilding(boolean worldGen)
    {
        ...
        for (int floor = 0; floor <= height; floor++)
        {
            ...
            // Center room
            peaces.add(new Structure(EnumStructurePeaces.NODE, floorBase.clone()));
            if (floor == 0)
            {
                peaces.add(new Structure(EnumStructurePeaces.FLOOR, floorBase.clone()));
            }
            if (floor == 0)
            {
            ...
            if (floor != height)
            {
                ...
                peaces.add(new Structure(EnumStructurePeaces.TUNNELC, floorBase.clone().translate(0, 0, -tunnelSpacing - (6 * width))));
                peaces.add(new Structure(EnumStructurePeaces.WALLZ, floorBase.clone().translate(0, 1, -tunnelSpacing - (6 * width) - 4)));
                ...
                peaces.add(new Structure(EnumStructurePeaces.TUNNELC, floorBase.clone().translate(+tunnelSpacing + (6 * width), 0, 0)));
                peaces.add(new Structure(EnumStructurePeaces.WALLX, floorBase.clone().translate(+tunnelSpacing + (6 * width) + 4, 1, 0)));
    ...
    public void load3x3Room(VectorWorld start, int center)
    {
        ...
        if (center == 0)
        {
            peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(0, 0, 0)));
        }
        else if (center == 1)
        {
            peaces.add(new Structure(EnumStructurePeaces.SKYLIGHT, start.clone().translate(0, +7, 0)));
            peaces.add(new Structure(EnumStructurePeaces.NODE, start.clone().translate(0, 0, 0)));
            peaces.add(new Structure(EnumStructurePeaces.TELEFLOOR, start.clone().translate(0, 0, 0)));
        }
        else if (center == 2)
        {
            peaces.add(new Structure(EnumStructurePeaces.SKYLIGHT, start.clone().translate(0, +7, 0)));
            peaces.add(new Structure(EnumStructurePeaces.NODE, start.clone().translate(0, 0, 0)));
            peaces.add(new Structure(EnumStructurePeaces.COREFLOOR, start.clone().translate(0, 0, 0)).worldGen());
        }
        // South
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(0, 0, 6)));
        // North
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(0, 0, -6)));
        // East
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(6, 0, 0)));
        // West
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(-6, 0, 0)));
        // Corners
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(6, 0, 6)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(-6, 0, -6)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(-6, 0, 6)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(6, 0, -6)));
        // Walls
        peaces.add(new Structure(EnumStructurePeaces.WALLX, start.clone().translate(10, 1, 6)));
        peaces.add(new Structure(EnumStructurePeaces.WALLZ, start.clone().translate(6, 1, 10)));
        peaces.add(new Structure(EnumStructurePeaces.WALLX, start.clone().translate(-10, 1, 6)));
        peaces.add(new Structure(EnumStructurePeaces.WALLZ, start.clone().translate(-6, 1, 10)));
        peaces.add(new Structure(EnumStructurePeaces.WALLX, start.clone().translate(10, 1, -6)));
        peaces.add(new Structure(EnumStructurePeaces.WALLZ, start.clone().translate(6, 1, -10)));
    ...
    public void load5x5Room(VectorWorld start, int center)
    {
        ...
        // South
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(0, 0, 6)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(0, 0, 12)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(-6, 0, 12)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(+6, 0, 12)));
        // North
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(0, 0, -6)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(0, 0, -12)));
        ...
        // East
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(6, 0, 0)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(12, 0, 0)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(12, 0, -6)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(12, 0, 6)));
        // West
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(-6, 0, 0)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(-12, 0, 0)));
        ...
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(-6, 0, 6)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(6, 0, -6)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(12, 0, 12)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(-12, 0, -12)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(-12, 0, 12)));
        peaces.add(new Structure(EnumStructurePeaces.TUNNELC, start.clone().translate(12, 0, -12)));
        // Walls
        peaces.add(new Structure(EnumStructurePeaces.WALLX, start.clone().translate(16, 1, 6)));
        peaces.add(new Structure(EnumStructurePeaces.WALLZ, start.clone().translate(6, 1, 16)));
        peaces.add(new Structure(EnumStructurePeaces.WALLX, start.clone().translate(-16, 1, 6)));
        peaces.add(new Structure(EnumStructurePeaces.WALLZ, start.clone().translate(-6, 1, 16)));
        peaces.add(new Structure(EnumStructurePeaces.WALLX, start.clone().translate(16, 1, -6)));
        peaces.add(new Structure(EnumStructurePeaces.WALLZ, start.clone().translate(6, 1, -16)));
        peaces.add(new Structure(EnumStructurePeaces.WALLX, start.clone().translate(-16, 1, -6)));
        peaces.add(new Structure(EnumStructurePeaces.WALLZ, start.clone().translate(-6, 1, -16)));
        peaces.add(new Structure(EnumStructurePeaces.WALLX, start.clone().translate(16, 1, 12)));
        peaces.add(new Structure(EnumStructurePeaces.WALLZ, start.clone().translate(12, 1, 16)));
        peaces.add(new Structure(EnumStructurePeaces.WALLX, start.clone().translate(-16, 1, 12)));
        peaces.add(new Structure(EnumStructurePeaces.WALLZ, start.clone().translate(-12, 1, 16)));
        peaces.add(new Structure(EnumStructurePeaces.WALLX, start.clone().translate(16, 1, -12)));
        peaces.add(new Structure(EnumStructurePeaces.WALLZ, start.clone().translate(12, 1, -16)));
    ...
    public void loadTunnel(VectorWorld start, ForgeDirection direction, int tunnelPeaces)
    {
        for (int i = 0; i < tunnelPeaces; i++)
        {
            ...
            {
                peaces.add(new Structure(EnumStructurePeaces.TUNNELZ, spot));
            }
            else if (direction == ForgeDirection.EAST || direction == ForgeDirection.WEST)
            {
                peaces.add(new Structure(EnumStructurePeaces.TUNNELX, spot));
            }
            else if (direction == ForgeDirection.UP || direction == ForgeDirection.DOWN)
            {
                peaces.add(new Structure(EnumStructurePeaces.NODE, spot));
                peaces.add(new Structure(EnumStructurePeaces.WALLX, spot.clone().translate(3, 1, 0)));
                peaces.add(new Structure(EnumStructurePeaces.WALLZ, spot.clone().translate(-3, 1, 0)));
                peaces.add(new Structure(EnumStructurePeaces.WALLX, spot.clone().translate(0, 1, -3)));
                peaces.add(new Structure(EnumStructurePeaces.WALLZ, spot.clone().translate(0, 1, 3)));
            }
        }
    }
